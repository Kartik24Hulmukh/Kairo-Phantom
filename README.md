...
pytest tests/test_oracle_signature.py -v   # 4 passed (tamper-detection)
pytest tests/test_corpus_integrity.py -v   # 4 passed (55 fixtures, v1.2.0)
pytest tests/test_injection_parity.py tests/test_injection_connector.py -v  # 34 passed
```
...
```bash
pytest tests/test_injection_parity.py tests/test_injection_connector.py -v  # 34 passed
pytest tests/test_injection_parity.py -v                                    # 13 parity tests
pytest tests/test_injection_connector.py -v                                 # 21 connector tests
```
